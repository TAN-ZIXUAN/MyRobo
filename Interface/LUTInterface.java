...
public interface LUTInterface extends CommonInterface{
    ...
    /**
     * A helper method that translate a vector being used to index the look up table
     * into an ordinary that can then be used to  access the associated look up table element.
